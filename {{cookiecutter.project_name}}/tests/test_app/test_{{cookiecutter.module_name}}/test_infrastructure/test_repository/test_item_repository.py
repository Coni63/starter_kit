...
from app.{{cookiecutter.module_name}}.infrastructure.repository.item_repository import ItemModel
from app.{{cookiecutter.module_name}}.infrastructure.repository.item_repository import ItemRepository
